...
- canonical: Precision={report['canonical']['precision']:.3f}, Recall={report['canonical']['recall']:.3f}, F1={report['canonical']['f1-score']:.3f}
- immune: Precision={report['immune']['precision']:.3f}, Recall={report['immune']['recall']:.3f}, F1={report['immune']['f1-score']:.3f}
- stromal: Precision={report['stromal']['precision']:.3f}, Recall={report['stromal']['recall']:.3f}, F1={report['stromal']['f1-score']:.3f}
