...
class CRCReportGenerator:
    ...
    def generate_molecular_subtype_report(self, results, image_data, timestamp=None):
        ...
        metadata_data = [
            ...
            ['Subtypes:', 'canonical (Canonical), immune (Immune), stromal (Stromal)']
        ]
        ...
        subtype_colors = {
            'canonical (Canonical)': HexColor('#e74c3c'),
            'immune (Immune)': HexColor('#27ae60'),
            'stromal (Stromal)': HexColor('#e67e22')
        }
        ...
        story.append(Paragraph("canonical (Canonical) Score:", self.styles['Normal']))
        story.append(Paragraph(
        ...
        story.append(Paragraph("immune (Immune) Score:", self.styles['Normal']))
        story.append(Paragraph(
        ...
        story.append(Paragraph("stromal (Stromal) Score:", self.styles['Normal']))
        story.append(Paragraph(
