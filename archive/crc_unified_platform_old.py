...
def display_molecular_results(results):
    ...
    # Subtype information
    subtype_info = {
                    'SNF1': {'color': '#ff006e', 'name': 'Canonical', 'prognosis': 'Variable', 'therapy': 'Combination therapy'},
            'SNF2': {'color': '#00f5ff', 'name': 'Immune', 'prognosis': 'Good', 'therapy': 'Immunotherapy'},
            'SNF3': {'color': '#ffaa00', 'name': 'Stromal', 'prognosis': 'Poor', 'therapy': 'Anti-angiogenic'},
